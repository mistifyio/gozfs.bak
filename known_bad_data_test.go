...
var decode_bad = []struct {
	...
	{"xdr:DecodeUint: unexpected EOF while decoding 4 bytes - read: '[0]'", []byte("\x01\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00")},
...
var encode_bad = []struct {
	...
	{"invalid Type 'UNKNOWN'", List{Pairs: []pair{pair{data: 0}}}},
	{"invalid Type 'dataType(28)'", List{Pairs: []pair{pair{Type: DOUBLE + 1}}}},
	//{"invalid Type 'UNKNOWN'", List{Pairs: []pair{pair{Type: NVLIST, data: List{}}}}},
	{"xdr:encodeInterface: can't encode nil interface", List{Pairs: []pair{pair{Type: STRING}}}},
	{"v is invalid", List{Pairs: []pair{pair{Type: NVLIST}}}},
	{"Pairs must not be empty", List{Pairs: []pair{pair{Type: NVLIST, data: List{}}}}},
	{"empty NVLIST_ARRAY", List{Pairs: []pair{pair{Type: NVLIST_ARRAY, data: []List{}}}}},
}
